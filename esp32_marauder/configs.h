#pragma once
  ...
  //// HARDWARE NAMES
    ...
    #define HARDWARE_NAME "ESP32 WROOM-32 with OLED"
  #elif defined(ESP32_TFT_NO_TOUCH)
    #define HARDWARE_NAME "ESP32 WROOM-32 with TFT"
  #else
 ...
 //// BOARD FEATURES
    ...
    #define HAS_BT
    //#define HAS_BUTTONS
    //#define HAS_BUTTON_PAD
    #define USES_APP_BUTTONS
    //#define HAS_NEOPIXEL_LED
    //#define HAS_PWR_MGMT
    //#define HAS_SCREEN
    //#define HAS_FULL_SCREEN
    #define HAS_128x160_SCREEN
    //#define HAS_GPS
    //#define HAS_C5_SD
    #define HAS_SD
    #define USE_SD
